...
After confirming that Jupyter is running, you can access it via your browser at localhost:8888/tree?token=33cb239ebab2736a6487a557fb1c472661838debdd552767 by setting up an SSH tunnel:
```bash
