...
echo "/sys/fs/cgroup/cpu/*/cpu.weight"
echo "/sys/fs/cgroup/cpu/*/*/cpu.weight"
echo "/sys/fs/cgroup/cpu/*/*/*/cpu.weight"
echo "/sys/fs/cgroup/cpu/*/*/*/*/cpu.weight"
...
echo "/sys/fs/cgroup/kubepods.slice/kubepods-burstable.slice/*/cpu.latency_awareness"
echo '1' | sudo tee -a /sys/fs/cgroup/kubepods.slice/kubepods-burstable.slice/*/cpu.latency_awareness
echo "--------"
